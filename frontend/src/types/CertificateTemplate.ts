...
export class CertificateMapper {
  static mapFormDataToTemplate(
    ...
    return {
      ...
      // Signatures
      technician: {
        name: formData.technicianName || 'Default Technician',
        signature: undefined // Can be added later
      },
      approvedBy: {
        name: 'Pongpat Kewarphan', // From template
        signature: undefined // Can be added later
      },
