  ...
  return (
    <div className="p-3 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-blue-600">Equipment Management</h1>
        {canModify && (
          <div className="flex gap-2 sm:gap-3">
            <button
              onClick={handleOpenCreateInstrument}
              className="bg-sky-500 text-white px-3 sm:px-4 py-2 rounded hover:bg-sky-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 text-sm sm:text-base"
              disabled={isLoading}
            >
              <FaPlus size={14} />
              <span className="hidden sm:inline">Add </span>Instrument
            </button>
            <button
              onClick={handleOpenCreateProbe}
              className="bg-orange-400 text-white px-3 sm:px-4 py-2 rounded hover:bg-orange-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 text-sm sm:text-base"
              disabled={isLoading}
            >
              <FaPlus size={14} />
              <span className="hidden sm:inline">Add </span>Probe
            </button>
          </div>
        )}
      </div>
